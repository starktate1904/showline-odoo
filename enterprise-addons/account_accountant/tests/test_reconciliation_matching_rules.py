...
class TestReconciliationMatchingRules(AccountTestInvoicingCommon):
    ...
    def test_matching_rules_payment_regex(self):
        ...
        bank_line_1 = self._create_st_line(amount=100, payment_ref='SO2025/127326425 - Erp Partner: Admin')
        bank_line_2 = self._create_st_line(amount=100, payment_ref='Erp Partner: Admin - SO2025/12237246-13')
    ...
    def test_get_common_substring_of_labels(self):
        ...
        short_normalised_refs = ['Erp ' + str(x) for x in (18, 19, 9000)]
