...
class SocialPostTemplate extends models.ServerModel {
    ...
    _records = [
        {
            id: 1,
            message: "Hello @Erp-Social, check this out: https://dev.erpsys.top #crazydeals #odoo",
            twitter_message:
            ...
            <div class="o_social_preview o_social_twitter_preview bg-white border rounded overflow-hidden w-100">
                ...
                <div class="d-table w-75 pb-3 mx-3">
                    <span class="o_social_preview_message">Hello <a href="https://twitter.com/Erp-Social" target="_blank" rel="noreferrer">@Erp-Social</a>, check this out: <a href="https://dev.erpsys.top" class="text-truncate" target="_blank" rel="noreferrer">https://dev.erpsys.top</a> <a href="https://twitter.com/hashtag/crazydeals?src=hash" target="_blank" rel="noreferrer">#crazydeals</a> <a href="https://twitter.com/hashtag/odoo?src=hash" target="_blank" rel="noreferrer">#odoo</a></span>
                </div>
                <a target="_blank" href="https://dev.erpsys.top" rel="noreferrer">
                    <div class="o_social_stream_post_image d-flex overflow-hidden                         o_social_stream_post_image_clickable">
                            <div class="w-100">
                                <img alt="Post Image" src="https://dev.erpsys.top/web/image/54404732-3d9bec26/SPI_homepage.png">
                            </div>
                    </div>
                    <div class="o_social_twitter_preview_article w-100 pb-1 d-block text-white">
                        <small class="p-1 mx-2 rounded">dev.erpsys.top</small>
                    </div>
                </a>
            </div>`,
        },
