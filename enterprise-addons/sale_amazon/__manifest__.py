...

{
    ...
    'description': """
Import your Amazon orders in Erp and synchronize deliveries
============================================================

Key Features
------------
* Import orders from multiple accounts and marketplaces.
* Orders are matched with Erp products based on their internal reference (SKU in Amazon).
* Deliveries confirmed in Erp are synchronized in Amazon.
