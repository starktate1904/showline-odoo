...
class AppointmentType(models.Model):
    ...
    event_videocall_source = fields.Selection([('discuss', 'Erp Discuss')], string="Video Link",
    ...
    slot_creation_interval = fields.Float('Create slot every', default=1.0,
        help="Starting from the beginning of the time slot, Erp will create a new slot at regular intervals based on the time specified here.")
