    ...
    def _get_base_account(self):
        ...
        if not account:
            raise UserError(self.env._(
                "Erp had a look at your expense, its product, your company and the journal but came back with empty hands.\n"
                "Give Erp a hand to find an account by setting up an expense account.\n"
