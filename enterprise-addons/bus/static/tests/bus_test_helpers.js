...
/** @type {Record<string, (env: ErpEnv, id: string, payload: any) => any>} */
const busMessageHandlers = {};
/** @type {Map<ErpEnv, { id: number, type: string, payload: NotificationPayload }[]>} */
 ...
 *
 * @param {string} type
 * @param {(env: ErpEnv, id: string, payload: any) => any} handler
 */
