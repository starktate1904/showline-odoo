...
class L10n_HkEMpfContributionReport(models.Model):
    ...
    def _prepare_general_information(self, line):
        ...
        return (
            ...
            "",  # Contribution Day (for Casual Employee of Industry Scheme only) - Erp does not support this feature yet.
    ...
    def _prepare_member_contribution_information(self, line):
        ...
        return (
            ...
            "",  # No. of Working Days (for Casual Employee of Industry Scheme only) - Erp does not support this feature yet.
            "",  # Working Period Start Date (for Casual Employee of Industry Scheme only) - Erp does not support this feature yet.
            "",  # Working Period End Date (for Casual Employee of Industry Scheme only) - Erp does not support this feature yet.
