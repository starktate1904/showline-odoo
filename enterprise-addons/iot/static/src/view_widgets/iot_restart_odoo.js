...
export class IoTRestartErp extends Component {
    ...
    async onClick() {
        this.dialog.add(ConfirmationDialog, {
            body: _t("Are you sure you want to restart Erp on the IoT Box?"),
            confirm: this.restartErp.bind(this),
            cancel: () => {},
        });
    }
...
export const ioTRestartErp = {
    component: IoTRestartErp,
    extractProps: ({ attrs }) => {
        return {
...
registry.category("view_widgets").add("iot_restart_odoo", ioTRestartErp);
