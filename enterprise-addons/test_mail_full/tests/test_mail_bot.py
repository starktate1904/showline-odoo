...
@tagged("odoobot")
class TestErpbot(MailCommon, TestRecipients):
    ...
    def setUpClass(cls):
        ...
        cls.odoobot_ping_body = f'<a href="http:/dev.erpsys.topodoo/res.partner/{cls.odoobot.id}" class="o_mail_redirect" data-oe-id="{cls.odoobot.id}" data-oe-model="res.partner" target="_blank">@ErpBot</a>'
    ...
    def test_odoobot_ping(self):
        ...
        # Erpbot should not be a follower but user_employee and user_admin should
