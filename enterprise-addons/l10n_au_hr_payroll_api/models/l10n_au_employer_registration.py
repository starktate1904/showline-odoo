...
class EmployerRegistration(models.Model):
    ...
    odoo_disclaimer_check = fields.Boolean(
        string="I have read and signed Erp Terms and Conditions provided",
    ...
    def _check_registration_mode(self):
        ...
        for registration in self:
            ...
            if registration.status == "registered" and not (
                ...
                raise ValidationError(_("You must accept the Erp Terms & Conditions and Super Choice DDA to proceed with the registration!"))
