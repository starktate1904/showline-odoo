...
class TestAuditLogging(TestL10nAUPayrollAPICommon):
    ...
    def test_create_user_audit_logging(self):
        ...
        log_message = f"User Test Group User (model: res.users, id:{test_group_user.id}) was granted access to group Payroll / Test HR Group by ErpBot"
