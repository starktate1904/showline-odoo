...
patch(PosStore.prototype, {
            ...
            const message = {
                ...
                unknown: _t(
                    "An unknown error has occurred! Try to validate this order or cancel it again. " +
                        "Please contact Erp for more information."
                ),
            };
     ...
     * send it to Erp. Two cases can happen:
     * - Failure to send to Fiskaly => we assume that if one order fails, EVERY order will fail
     * - Failure to send to Erp => the order is already sent to Fiskaly, we store them locally with the TSS info
     */
