...
class SocialTwitterCase(SocialCase):
    ...
    def test_tweet_post_message_counter(self):
        message_to_post = '''
            Erp is a suite of business management software tools including,
            ...
            the framework and core ERP modules is curated by the Belgium-based Erp S.A.
            Erp is available for both on-premise and ready to use SaaS environment.
        '''
