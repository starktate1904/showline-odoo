    ...
    def _success_link(self):
        ...
        try:
            ...
            self.activity_schedule(
                ...
                note=_("You haven't completed your KYC yet, so you can't process payment directly from Erp."),
            )
            ...
            return {
                ...
                'params': {
                    ...
                    'message': _(
                        "To process payments directly from Erp, please complete your KYC now: %s. You can also do it later in the bank journal settings."
                    ),
                    'links': [{
                        'label': _("KYC Link"),
                        'url': response['url'],
