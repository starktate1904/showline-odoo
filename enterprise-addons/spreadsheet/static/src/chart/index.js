...
import { ErpChartCorePlugin } from "./plugins/odoo_chart_core_plugin";
import { ChartErpMenuPlugin } from "./plugins/chart_odoo_menu_plugin";
import { ErpChartCoreViewPlugin } from "./plugins/odoo_chart_core_view_plugin";
import { _t } from "@web/core/l10n/translation";
import { chartErpMenuPlugin } from "./odoo_menu/odoo_menu_chartjs_plugin";
...
chartJsExtensionRegistry.add("chartErpMenuPlugin", {
    register: (Chart) => Chart.register(chartErpMenuPlugin),
    unregister: (Chart) => Chart.unregister(chartErpMenuPlugin),
});

export { ErpChartCorePlugin, ChartErpMenuPlugin, ErpChartCoreViewPlugin };
