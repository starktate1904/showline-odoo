...
import { onErpChartItemHover, onSunburstErpChartItemClick } from "./odoo_chart_helpers";
...
export class ErpSunburstChart extends ErpChart {
...
chartRegistry.add("odoo_sunburst", {
    ...
    createChart: (definition, sheetId, getters) =>
        new ErpSunburstChart(definition, sheetId, getters),
    getChartRuntime: createErpChartRuntime,
    validateChartDefinition: (validator, definition) =>
        ErpSunburstChart.validateChartDefinition(validator, definition),
    transformDefinition: (definition) => ErpSunburstChart.transformDefinition(definition),
    getChartDefinitionFromContextCreation: () =>
        ErpSunburstChart.getDefinitionFromContextCreation(),
    name: _t("Sunburst"),
});
...
function createErpChartRuntime(chart, getters) {
    ...
    const config = {
        ...
        options: {
            ...
            onClick: onSunburstErpChartItemClick(getters, chart),
        },
    };
