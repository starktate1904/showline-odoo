...
export class ErpScatterChart extends ErpChart {
...
chartRegistry.add("odoo_scatter", {
    ...
    createChart: (definition, sheetId, getters) =>
        new ErpScatterChart(definition, sheetId, getters),
    getChartRuntime: createErpChartRuntime,
    validateChartDefinition: (validator, definition) =>
        ErpScatterChart.validateChartDefinition(validator, definition),
    transformDefinition: (definition) => ErpScatterChart.transformDefinition(definition),
    getChartDefinitionFromContextCreation: () =>
        ErpScatterChart.getDefinitionFromContextCreation(),
    name: _t("Scatter"),
});
