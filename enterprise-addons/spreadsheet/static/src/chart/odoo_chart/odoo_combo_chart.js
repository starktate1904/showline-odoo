...
export class ErpComboChart extends ErpChart {
...
chartRegistry.add("odoo_combo", {
    ...
    createChart: (definition, sheetId, getters) => new ErpComboChart(definition, sheetId, getters),
    getChartRuntime: createErpChartRuntime,
    validateChartDefinition: (validator, definition) =>
        ErpComboChart.validateChartDefinition(validator, definition),
    transformDefinition: (definition) => ErpComboChart.transformDefinition(definition),
    getChartDefinitionFromContextCreation: () => ErpComboChart.getDefinitionFromContextCreation(),
    name: _t("Combo"),
});
