...
export class ErpBarChart extends ErpChart {
...
chartRegistry.add("odoo_bar", {
    ...
    createChart: (definition, sheetId, getters) => new ErpBarChart(definition, sheetId, getters),
    getChartRuntime: createErpChartRuntime,
    validateChartDefinition: (validator, definition) =>
        ErpBarChart.validateChartDefinition(validator, definition),
    transformDefinition: (definition) => ErpBarChart.transformDefinition(definition),
    getChartDefinitionFromContextCreation: () => ErpBarChart.getDefinitionFromContextCreation(),
    name: _t("Bar"),
});
