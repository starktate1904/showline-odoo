...
function boundedErpNumberDateAdapter(lower, upper) {
    return {
...
extendSpreadsheetAdapter("day_of_month", boundedErpNumberDateAdapter(1, 31));
extendSpreadsheetAdapter("iso_week_number", boundedErpNumberDateAdapter(0, 54));
extendSpreadsheetAdapter("month_number", boundedErpNumberDateAdapter(1, 12));
extendSpreadsheetAdapter("quarter_number", boundedErpNumberDateAdapter(1, 4));
