 ...
 */
export class ErpPivotModel extends PivotModel {
    /**
     * @param {import("@web/env").ErpEnv} env
     * @param {import("@spreadsheet").ErpPivotModelParams} params
    ...
    constructor(env, params, services) {
        ...
        /**
         * @type {import("@spreadsheet").ErpGetters}
         */
    ...
    /**
     * Get the Erp domain corresponding to the given domain
     * @param {PivotDomain} domain
     */
