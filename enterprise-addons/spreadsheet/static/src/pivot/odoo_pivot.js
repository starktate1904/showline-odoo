...
import { NO_RECORD_AT_THIS_POSITION, ErpPivotModel } from "./pivot_model";
...
import { ErpPivotLoader } from "./odoo_pivot_loader";
 ...
 * @typedef {import("@spreadsheet").ErpPivot<ErpPivotRuntimeDefinition>} IPivot
 * @typedef {import("@spreadsheet").ErpFields} ErpFields
 * @typedef {import("@spreadsheet").ErpPivotCoreDefinition} ErpPivotCoreDefinition
 * @typedef {import("@spreadsheet").ErpGetters} ErpGetters
 * @typedef {import("@spreadsheet/data_sources/odoo_data_provider").ErpDataProvider} ErpDataProvider
 */

/**
 * @implements {IPivot}
 */
export class ErpPivot {
    /**
     *
     * @override
     * @param {Object} services Services (see DataSource)
     * @param {Object} params
     * @param {ErpPivotCoreDefinition} params.definition
     * @param {ErpGetters} params.getters
     */
    constructor(services, { definition, getters }) {
        /** @type {"ODOO"} */
        this.type = "ODOO";

        /** @type {ErpPivotCoreDefinition} @protected */
        this.coreDefinition = definition;

        this.needsReevaluation = false;

        /** @type {ErpPivotRuntimeDefinition | undefined} @protected */
        this.runtimeDefinition = undefined;

        /** @type {ErpPivotModel | undefined} @protected */
        this.model = undefined;

        /** @type {ErpGetters} @protected */
        this.getters = getters;

        /** @protected */
        this.loader = new ErpPivotLoader(services.odooDataProvider, this._load.bind(this));

        /** @type {ErpFields | undefined} @protected */
        this._fields = undefined;

        /** @protected @type {ErpDataProvider}*/
    ...
    /**
     * @param {ErpPivotCoreDefinition} nextDefinition
     */
    onDefinitionChange(nextDefinition) {
        ...
        if (
            ...
            if (
                ...
                this.coreDefinition = nextDefinition;
                const runtimeDefinition = new ErpPivotRuntimeDefinition(
                    this.coreDefinition,
                    this.getFields()
                );
    ...
    async createModelAndDefinition() {
        ...
        const definition = new ErpPivotRuntimeDefinition(this.coreDefinition, this.getFields());
        const model = new ErpPivotModel(
            { _t },
            {
...
export class ErpPivotRuntimeDefinition extends PivotRuntimeDefinition {
    /**
     * @param {ErpPivotCoreDefinition} definition
     * @param {ErpFields} fields
     */
...
pivotRegistry.add("ODOO", {
    ui: ErpPivot,
    definition: ErpPivotRuntimeDefinition,
    externalData: true,
