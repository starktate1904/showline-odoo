...
/**
 * @typedef {import("@spreadsheet").ErpField} ErpField
 * @typedef {import("@spreadsheet").ErpFields} ErpFields
 */

/**
 * @typedef {Object} ErpModelMetaData
 * @property {string} resModel
 * @property {ErpFields} [fields]
 *
 * @typedef {Object} ErpModelSearchParams
 * @property {Object} context
 * @property {Array<string>} domain
 */

export class ErpViewsDataSource extends LoadableDataSource {
    /**
     * @override
     * @param {Object} services
     * @param {Object} params
     * @param {ErpModelMetaData} params.metaData
     * @param {Object} params.searchParams
     */
    constructor(services, params) {
        super(services);
        /** @type {ErpModelMetaData} */
    ...
    /**
     * @returns {ErpFields} List of fields
     */
    getFields() {
     ...
     * @returns {ErpField | undefined} Field
     */
    getField(field) {
        this._assertMetaDataLoaded();
