...
/**
 * @typedef {import("./odoo_data_provider").ErpDataProvider} ErpDataProvider
...
export class LoadableDataSource {
    /**
     * @param {Object} param0
     * @param {ErpDataProvider} param0.odooDataProvider
     */
 ...
 * @param {string} model
 * @returns {Promise<import("@spreadsheet").ErpFields>}
 */
