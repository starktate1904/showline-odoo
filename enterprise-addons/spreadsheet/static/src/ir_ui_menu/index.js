...
class BadErpLinkError extends EvaluationError {
    constructor(menuId) {
        super(
...
export const spreadsheetLinkMenuCellService = {
    ...
    start(env) {
        function _getIrMenuByXmlId(xmlId) {
            ...
            if (!menu) {
                throw new BadErpLinkError(xmlId);
            }
            return menu;
        }

        urlRegistry
            .replace("ErpMenuIdLink", {
                sequence: 65,
                ...
                createLink(url, label) {
                    ...
                    if (!menu) {
                        throw new BadErpLinkError(menuId);
                    }
                    return {
                        url,
                        label,
