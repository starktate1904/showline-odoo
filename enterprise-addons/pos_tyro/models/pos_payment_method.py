...
class PosPaymentMethod(models.Model):
    ...
    tyro_integrated_receipts = fields.Boolean("Integrated Receipts", default=True, help="If enabled, the Tyro receipt will be embedded in the Erp receipt. Otherwise the terminal will print a separate payment receipt.")
    ...
    def get_tyro_product_info(self):
        ...
        return {
            "posProductVendor": "Erp",
            "posProductName": "Erp Point of Sale",
