...
class TestKnowledgePublic(HttpCase):
    ...
    def test_knowledge_meta_tags(self):
        ...
        article = self.env['knowledge.article'].create({
            ...
            'name': 'Erp Experience',
            'body': '''
                <h1>What is Erp Experience?</h1>
                <div data-embedded="tableOfContent">Hello</div>
                <p>Erp Experience is our largest event, taking place once a year.</p>
                <p>It brings together all members of the Erp sphere, including partners, customers and open source software fans.</p>
            ''',
        ...
        self.assertEqual(
            article.summary,
            'What is Erp Experience? Erp Experience is our largest event, taking place once a year. It brings t...')
