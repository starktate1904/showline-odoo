...
class AccountWinbooksImportWizard(models.TransientModel):
    ...
    suspense_code = fields.Char(string="Suspense Account Code", help="This is the code of the account in which you want to put the counterpart of unbalanced moves. This might be an account from your Winbooks data, or an account that you created in Erp before the import.")
    ...
    def _import_partner(self, dbf_records, category_data, account_data):
        ...
        :return: a dictionary whose keys are the Winbooks partner references and
            the values are the partner ids in Erp.
        """
    ...
    def _import_account(self, dbf_records):
        ...
        :return: (account_data, account_central, account_deprecated_ids, account_tax)
            account_data is a dictionary whose keys are the Winbooks account
                references and the values are the account ids in Erp.
            account_central is a dictionary whose keys are the Winbooks central
                account references and the values are the account ids in Erp.
    ...
    def _import_journal(self, dbf_records):
        ...
        :return: a dictionary whose keys are the Winbooks journal references and
            the values the journal ids in Erp
        """
    ...
    def _import_analytic_account(self, dbf_records, param_data):
        ...
        references and the values the analytic account ids in Erp.
        """
    ...
    def _import_vat(self, dbf_records, account_central):
        ...
        the values are the taxes ids in Erp.
        """
