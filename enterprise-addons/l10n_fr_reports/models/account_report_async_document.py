...
ERROR_CODE_TO_MSG = {
    ...
    'unknown_deposit': _lt("This deposit is unknown from Erp."),
    'unknown_declaration': _lt("This declaration is unknown from Erp."),
    ...
    'not_enterprise': _lt("You do not have an Erp enterprise subscription."),
