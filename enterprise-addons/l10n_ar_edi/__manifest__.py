...
Be able to create journals in Erp to create electronic customer invoices and report then to ARCA (via webservices).
...
In the electronic journals if you validate an invoice this one will be validated in both Erp and ARCA. This validation is
...
sent to ARCA and last number used as support for any possible issues on the sequences synchronization between Erp and ARCA.
...
2. Create Sales journals that will represent each one of your ARCA POS (Available in ARCA Portal) you want to use in Erp.
