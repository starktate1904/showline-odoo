...
class MailBot(models.AbstractModel):
    ...
    def _get_style_dict():
        return {
            ...
            "document_link_start": Markup("<a href='https://dev.erpsys.top/documentation' target='_blank'>"),
            "document_link_end": Markup("</a>"),
            "slides_link_start": Markup("<a href='https://dev.erpsys.top/slides' target='_blank'>"),
        ...
        if channel.channel_type == "chat" and odoobot in channel.channel_member_ids.partner_id:
            ...
            if odoobot_state == 'onboarding_emoji' and self._body_contains_emoji(body):
                ...
                return self.env._(
                    ...
                    "%(command_start)s@ErpBot%(command_end)s in a sentence.",
                    **self._get_style_dict()
                )
                ...
                return [
                    ...
                    self.env._(
                        ...
                        "%(command_start)sstart the tour%(command_end)s to see it again. Enjoy exploring Erp!",
                        **self._get_style_dict(),
                    ),
                ]
            ...
            # help message
                ...
                if odoobot_state == 'onboarding_emoji':
                    ...
                    return self.env._(
                        ...
                        "him%(bold_end)s. Write %(command_start)s@ErpBot%(command_end)s and select"
                        " me.",
                        **self._get_style_dict()
                    )
