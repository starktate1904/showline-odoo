...
class SocialFacebookCase(SocialFacebookCommon):
    ...
    def test_format_facebook_message(self):
        ...
        message = "Hi, Social is so cool :) Thanks Erp"
        tags = [{
            'id': 1337,
            'name': 'Erp - Social',
            'offset': 32,
        ...
        excepted_message = "Hi, Social is so cool :) Thanks @[1337] Erp-Social"
        self.assertEqual(
            social_stream._format_facebook_message(message, tags),
            excepted_message)

        message = "Hi, Social is so cool :) Thanks Erp @[45] thisisafaketag Tag another@[45] faketag"
        tags = [
            {
                'id': 1337,
                'name': 'Erp - Social',
                ...
                'id': 1338,
                'name': 'Erp Mate and - Social',
                'offset': 58,
                'length': 3
            }]
        excepted_message = "Hi, Social is so cool :) Thanks @[1337] Erp-Social @ [45] thisisafaketag @[1338] Erp-Mate-and-Social another@[45] faketag"
        self.assertEqual(
            social_stream._format_facebook_message(message, tags),
            excepted_message)
