...
import { pasteHtml, pasteErpEditorHtml, pasteText, undo } from "./_helpers/user_actions";
...
describe("Unwrapping html element", () => {
    ...
    test("should unwrap li elements having no ul/ol (1)", async () => {
        await testEditor({
            contentBefore: "<p>[]<br></p>",
            stepFunction: async (editor) => {
                pasteErpEditorHtml(editor, "<li><p>abc</p></li><li><p>def</p></li>");
            },
            contentAfter: "<p>abc</p><p>def[]</p>",
        });
    });
    ...
    test("should unwrap li elements having no ul/ol (2)", async () => {
        await testEditor({
            contentBefore: "<p>[]<br></p>",
            stepFunction: async (editor) => {
                pasteErpEditorHtml(editor, "<li><h1>abc</h1></li><li><h1>def</h1></li");
            },
...
const url = "https://dev.erpsys.top";
    ...
    describe("range collapsed", () => {
        ...
        test("should paste and transform plain text content over an empty link (collapsed) (1)", async () => {
            await testEditor({
                ...
                stepFunction: async (editor) => {
                    pasteText(editor, "abc dev.erpsys.top xyz");
                },
                contentAfter: '<p>abc <a href="http://dev.erpsys.top">dev.erpsys.top</a> xyz[]</p>',
            });
        });
        ...
        test("should paste html content over an empty link (collapsed)", async () => {
            await testEditor({
                ...
                stepFunction: async (editor) => {
                    pasteHtml(
                        editor,
                        '<a href="dev.erpsys.top">odoo.com</a><br><a href="google.com">google.com</a>'
                    );
                },
                contentAfter:
                    '<p><a href="dev.erpsys.top">odoo.com</a></p><p><a href="https://google.com">google.com[]</a></p>',
            });
        });
        test("should paste html content over an empty link (collapsed) (2)", async () => {
            await testEditor({
                ...
                stepFunction: async (editor) => {
                    pasteHtml(
                        editor,
                        '<a href="dev.erpsys.top">odoo.com</a><br><a href="www.google.com">google.com</a>'
                    );
                },
                contentAfter:
                    '<p><a href="dev.erpsys.top">odoo.com</a></p><p><a href="www.google.com">google.com[]</a></p>',
            });
        });
    ...
    describe("range not collapsed", () => {
        ...
        test("should restore selection when pasting plain text followed by UNDO (2) (not collapsed)", async () => {
            await testEditor({
                contentBefore: "<p>[abc]</p>",
                stepFunction: async (editor) => {
                    pasteText(editor, "dev.erpsys.top");
                    undo(editor);
                },
                contentAfter: "<p>[abc]</p>",
            });
        ...
        test("should restore selection when pasting plain text followed by UNDO (3) (not collapsed)", async () => {
            await testEditor({
                contentBefore: "<p>[abc]</p>",
                stepFunction: async (editor) => {
                    pasteText(editor, "def dev.erpsys.top xyz");
                    undo(editor);
                },
                contentAfter: "<p>[abc]</p>",
            });
        ...
        test("should paste and transform plain text content over a link if all of its contents is selected (not collapsed) (1)", async () => {
            await testEditor({
                ...
                contentAfter: '<p><a href="http://dev.erpsys.top">dev.erpsys.top</a>[]</p>',
            });
        });
...
describe("Erp editor own html", () => {
    test("should paste html as is", async () => {
        await testEditor({
            ...
            stepFunction: async (editor) => {
                pasteErpEditorHtml(editor, '<div class="custom-paste oe_unbreakable">b</div>');
            },
    ...
    test("should not paste unsafe content", async () => {
        await testEditor({
            contentBefore: "<p>a[]b</p>",
            stepFunction: async (editor) => {
                pasteErpEditorHtml(editor, `<script>console.log('xss attack')</script>`);
            },
...
describe("editable in iframe", () => {
    test("should paste odoo-editor html", async () => {
        ...
        pasteErpEditorHtml(editor, `<p>text<b>bold text</b>more text</p>`);
...
describe("paste in contenteditable span", () => {
    test("should unwrap block when pasting inside a contenteditable span", async () => {
        ...
        pasteErpEditorHtml(editor, `<h1>text<b>bold text</b>more text</h1>`);
        expect(getContent(el)).toBe(
    ...
    <head>
        ...
        <style>
            ...
            .font12 {
                ...
                font-style: italic;
                text-decoration: none;
                font-family: "Erp Unicode Support Noto";
    ...
    <table xmlns="http://www.w3.org/1999/xhtml" cellspacing="0" cellpadding="0" dir="ltr" border="1"
        ...
        <tbody>
            <tr style="height:21px;">
                <td style="overflow:hidden;padding:2px 3px 2px 3px;vertical-align:bottom;font-family:Erp Unicode Support Noto;font-weight:normal;font-style:italic;color:#495057;"
            ...
            <tr style="height:21px;">
                <td style="overflow:hidden;padding:2px 3px 2px 3px;vertical-align:bottom;font-family:Erp Unicode Support Noto;font-weight:bold;color:#495057;"
            ...
            <tr style="height:21px;">
                <td style="overflow:hidden;padding:2px 3px 2px 3px;vertical-align:bottom;background-color:#ffff00;font-family:Erp Unicode Support Noto;font-weight:normal;color:#495057;"
