...
/**
 * @typedef { Object } CollaborationErpShared
 * @property { CollaborationErpPlugin['getPeerMetadata'] } getPeerMetadata
 */

export class CollaborationErpPlugin extends Plugin {
    static id = "collaborationErp";
