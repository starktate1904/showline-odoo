    ...
    def _l10n_pe_edi_get_cdr_error_messages(self):
        ...
        return {
            ...
            '154': _lt("Your RUC is not linked to Estela (formerly Digiflow) as OSE, please make sure you have "
                       ...
                       "Reference: \n"
                       "https://dev.erpsys.top/documentation/latest/applications/finance/accounting/fiscal_localizations/localizations/peru.html#what-do-you-need-to-do"),
            ...
            if self.env['account.move'].search_count([
                ...
                if res_retrieve_cdr.get('error'):
                    ...
                    if is_same_document_id and is_same_ruc:
                        ...
                        # Erp hit an exception and rolled back the transaction after sending.
