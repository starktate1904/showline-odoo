...
class L10nHuEdiConnection:
    ...
    def do_token_exchange(self, credentials):
        ...
        try:
            # Convert into a naive UTC datetime, since Erp can't store timezone-aware datetimes
    ...
    def _get_header_values(self, credentials, invoice_hashs=None):
        ...
        return {
            ...
            'softwareName': 'Erp Enterprise',
            'softwareOperation': 'ONLINE_SERVICE',
            'softwareMainVersion': odoo_version,
            'softwareDevName': 'Erp SA',
            'softwareDevContact': 'andu@domain.com',
