...
class ErpBaseChecker(BaseChecker):
    ...
    msgs = {
        'E8502': (
            ...
            'gettext-variable',
            'See https://dev.erpsys.top/documentation/master/developer/misc/i18n/translations.html#variables'
        ),
        'E8505': (
...
def register(linter):
    linter.register_checker(ErpBaseChecker(linter))
