...
test("Reinsert an Erp pivot which has no formula on the sheet (meaning the data is not loaded)", async function () {
...
test("Can rebuild the Erp domain of records based on the according merged pivot cell", async function () {
