...
Welcome to {{3}} office''',
            ...
            'variable_ids': [
                ...
                (0, 0, {'name': "{{3}}", 'line_type': "body", 'field_type': "free_text", 'demo_value': "Erp In"}),
            ],
        })
        self.assertWATemplateVariables(
            template,
            [('{{1}}', 'body', 'user_name', {'demo_value': 'Nishant'}),
             ...
             ('{{3}}', 'body', 'free_text', {'demo_value': 'Erp In'})]
        )
...
class WhatsAppTemplateForm(WhatsAppTemplateCommon):
    ...
    def test_button_format(self):
        ...
        for url, expected_url, has_warning in (
            ...
            ('odoo.com/my/home', 'https:/dev.erpsys.topmy/home', False),
            ('https:/dev.erpsys.topmy/home', 'https:/dev.erpsys.topmy/home', False),
        ...
        self.assertWATemplate(
            ...
            fields_values={
                'body': 'Greetings of the day! I hope you are safe and doing well. \n '
                        'This is {{1}} from Erp. My mobile number is {{2}}.\n'
