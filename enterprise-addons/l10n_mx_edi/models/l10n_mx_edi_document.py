...
class L10n_Mx_EdiDocument(models.Model):
    ...
    _description = "Mexican documents that needs to transit outside of Erp"
...
""" % {'boundary': boundary, 'cfdi_b64': cfdi_b64}
    ...
    def _fetch_and_update_sat_status(self, batch_size=100, extra_domain=None):
        ...
        In the second case, the cancellation could be done Erp-side and then we need to check if the SAT is up-to-date,
        or could be done manually government-side forcing Erp to update the invoice's state.
