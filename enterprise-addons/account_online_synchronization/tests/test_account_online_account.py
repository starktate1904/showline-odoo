...
class TestAccountOnlineAccount(AccountOnlineSynchronizationCommon):
    ...
    def test_delete_with_redirect_error(self, patched_request):
        ...
        # such error are returned as a ErpFinRedirectException with mode link to reopen the iframe and link with a new
    ...
    def test_redirect_mode_link(self, patched_request):
        # Use case being tested: Call to open the iframe which result in a ErpfinRedirectException in link mode
