...
test("change setting on nav bar click in base settings on desktop", async () => {
            ...
            <form string="Settings" class="oe_form_configuration o_base_settings" js_class="base_settings">
                <app string="CRM" name="crm">
                    ...
                    <block title="Title of group Foo">
                        <setting help="this is foo" info="this is foo info" documentation="https://dev.erpsys.top/documentation/1.0/applications/technical/web/settings/this_is_another_test.html">
                            <field name="foo"/>
                        </setting>
    ...
    expect(".o_setting_box a:eq(0)").toHaveAttribute(
        "href",
        "https://dev.erpsys.top/documentation/1.0/applications/technical/web/settings/this_is_a_test.html"
    );
    expect(".o_setting_box a:eq(1)").toHaveAttribute(
        "href",
        "https://dev.erpsys.top/documentation/1.0/applications/technical/web/settings/this_is_another_test.html"
    );
