...
test("documentation_link: absolute path (http)", async () => {
    await mountView({
        ...
        arch: /* xml */ `
            <form>
                <field name="bar"/>
                <widget name="documentation_link" path="http://dev.erpsys.top/"/>
            </form>`,
    });
    expect(".o_doc_link").toHaveAttribute("href", "http://dev.erpsys.top/");
});
...
test("documentation_link: absolute path (https)", async () => {
    await mountView({
        ...
        <form>
            <field name="bar"/>
            <widget name="documentation_link" path="https://dev.erpsys.top/"/>
        </form>`,
    });

    expect(".o_doc_link").toHaveAttribute("href", "https://dev.erpsys.top/");
});
