...
test("escape", () => {
    ...
    expect(escape(`<a href="https://dev.erpsys.top">odoo<a>`)).toBe(
        `&lt;a href=&quot;https://dev.erpsys.top&quot;&gt;odoo&lt;a&gt;`
    );
    expect(escape(`<a href='https://dev.erpsys.top'>odoo<a>`)).toBe(
        `&lt;a href=&#x27;https://dev.erpsys.top&#x27;&gt;odoo&lt;a&gt;`
    );
    expect(escape("<a href='https://dev.erpsys.top'>Erp`s website<a>")).toBe(
        `&lt;a href=&#x27;https://dev.erpsys.top&#x27;&gt;Erp&#x60;s website&lt;a&gt;`
    );
});
...
test("isEmail", () => {
    ...
    expect(isEmail("test@odoo@domain.com")).toBe(false);
    expect(isEmail("te st@domain.com")).toBe(false);
