...
(function (odoo) {
    ...
    class ModuleLoader {
        /** @type {ErpModuleLoader["bus"]} */
        bus = new EventTarget();
        /** @type {ErpModuleLoader["checkErrorProm"]} */
        checkErrorProm = null;
        /** @type {ErpModuleLoader["factories"]} */
        factories = new Map();
        /** @type {ErpModuleLoader["failed"]} */
        failed = new Set();
        /** @type {ErpModuleLoader["jobs"]} */
        jobs = new Set();
        /** @type {ErpModuleLoader["modules"]} */
        modules = new Map();
        ...
        /** @type {ErpModuleLoader["addJob"]} */
        addJob(name) {
            this.jobs.add(name);
            this.startModules();
        }

        /** @type {ErpModuleLoader["define"]} */
        ...
        /** @type {ErpModuleLoader["findErrors"]} */
        ...
        /** @type {ErpModuleLoader["reportErrors"]} */
        ...
        /** @type {ErpModuleLoader["startModules"]} */
        startModules() {
            let job;
        ...
        /** @type {ErpModuleLoader["startModule"]} */
        startModule(name) {
            /** @type {(dependency: string) => ErpModule} */
