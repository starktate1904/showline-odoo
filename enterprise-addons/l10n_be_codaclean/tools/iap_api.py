...
def get_error_message(error):
    ...
    return {
        ...
        "iap_error_server": _("An internal error occurred on the IAP server. Please contact Erp support."),
        "iap_error_connecting": _("An error occurred while connecting to the IAP server. If the error persists please contact Erp support."),
    ...
    }.get(error_type, _("Unknown error '%s' while contacting IAP / Codaclean. Please contact Erp support.", error_type))
