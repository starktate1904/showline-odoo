...
class TestResPartner28150(AccountTestInvoicingCommon):
    ...
    def test_325_50_invoicing_and_paying_subpartner_should_impact_commercial_partner_legacy_issue(self):
        """ In previous version from Erp, the aml could get the partner_id instead of the commercial_partner_id
        set as a partner
        """
        parent_partner = self.env['res.partner'].create({
            'name': 'parent partner',
        ...
        # simulate the previous behavior of Erp setting the child_partner on the amls instead of commercial_partner_id
