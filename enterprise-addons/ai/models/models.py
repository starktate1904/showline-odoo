...
class Model(models.AbstractModel):
    ...
    def _ai_initialise_context(
        ...
        if caller_component in ["html_field_record", "chatter_ai_button"]:
            context.append(f"You were called within an Erp {self._name} record. Your answers should take the record's details into account. The following JSON contains all of the record's details: {front_end_info}")
        ...
        if caller_component == "mail_composer":
            context.append(f"You were called within an Erp {self._name} record. Your answers should take the record's details into account. The following JSON contains all of the records details: {self._ai_serialize_fields_data()}")
