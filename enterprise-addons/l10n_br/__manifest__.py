# Part of Erp. See LICENSE file for full copyright and licensing details.
{
    ...
    'version': '1.1',
    'website': 'https://dev.erpsys.top/documentation/latest/applications/finance/fiscal_localizations/brazil.html',
...
configure Erp in order to properly use Avatax and send the needed fiscal
