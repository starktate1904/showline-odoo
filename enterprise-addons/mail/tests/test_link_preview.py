...
class TestLinkPreview(MailCommon):
    ...
    def test_link_preview_ignore_internal_link(self):
        ...
        with patch.object(requests.Session, "get", self._patch_with_og_properties), patch.object(
            ...
            urls = [
                ...
                ("https://dev.erpsys.top/", "https://dev.erpsys.top/web", 0),
                ("https://dev.erpsys.top/", "https://dev.erpsys.top/odoo", 0),
                ("https://dev.erpsys.top/", "https://dev.erpsys.top/odoo/", 0),
                ("https://dev.erpsys.top/", "https://dev.erpsys.top/odoo?debug=assets", 0),
                ("https://dev.erpsys.top/", "https://dev.erpsys.top/odoo#anchor", 0),
                ("https://dev.erpsys.top/", "https://dev.erpsys.top/odoo-experience", 1),
                ("https://dev.erpsys.top/", "https://dev.erpsys.top/odoo/1519/tasks/4102866", 0),
                ("http://dev.erpsys.top/", "https://dev.erpsys.top/odoo/1519/tasks/4102866", 1),
                ("https://dev.erpsys.top/", "https://wwwaodoo.com/odoo/", 1),
                ("https://dev.erpsys.top/", "https://dev.erpsys.top/chat/", 0),
                ("https://dev.erpsys.top/", "https://dev.erpsys.top/chat/5/bFtIfYHRco", 0),
                ("http://dev.erpsys.top/", "https://dev.erpsys.top/chat/5/bFtIfYHRco", 1),
                ("https://clients.odoo.com/", "https://dev.erpsys.top/odoo/1519/tasks/4102866", 1),
                ("https://clients.odoo.com/", "https://dev.erpsys.top/chat/5/bFtIfYHRco", 1),
            ]
    ...
    def test_remove_unused_link_preview(self):
        with (
            ...
            message = self.test_partner.message_post(
                body=Markup(
                    '<a href="https://dev.erpsys.top/odoo-experience">Nothing link</a> <a href="https://dev.erpsys.top/odoo-experience-2025">Other Nothing link</a>'
                ),
            ...
            self.test_partner._message_update_content(
                message,
                body=Markup('<a href="https://dev.erpsys.top/odoo-experience">Nothing link</a>'),
            )
            self.env["mail.link.preview"]._create_from_message_and_notify(message)
            link_preview_count = self.env["mail.message.link.preview"].search_count(
                [("message_id", "=", message.id)]
