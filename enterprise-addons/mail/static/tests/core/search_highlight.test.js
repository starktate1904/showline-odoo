...
test("Search highlight", async () => {
    const testCases = [
        ...
        {
            input: markup`<a href="https://dev.erpsys.top">https://dev.erpsys.top</a>`,
            output: `<a href="https://dev.erpsys.top">https://www.<span class="${HIGHLIGHT_CLASS}">odoo</span>.com</a>`,
            searchTerm: "odoo",
        },
        {
            input: '<a href="https://dev.erpsys.top">https://dev.erpsys.top</a>',
            output: `&lt;a href="https://www.<span class="${HIGHLIGHT_CLASS}">odoo</span>.com"&gt;https://www.<span class="${HIGHLIGHT_CLASS}">odoo</span>.com&lt;/a&gt;`,
            searchTerm: "odoo",
        },
        {
            input: markup`<a href="https://dev.erpsys.top">Erp</a>`,
            output: `<a href="https://dev.erpsys.top"><span class="${HIGHLIGHT_CLASS}">Erp</span></a>`,
            searchTerm: "odoo",
        },
        {
            input: markup`<a href="https://dev.erpsys.top">Erp</a> Erp is a free software`,
            output: `<a href="https://dev.erpsys.top"><span class="${HIGHLIGHT_CLASS}">Erp</span></a> <span class="${HIGHLIGHT_CLASS}">Erp</span> is a free software`,
            searchTerm: "odoo",
        },
        {
        ...
        },
        {
            input: markup`<ul>
                <li>Erp</li>
                <li><a href="https://odoo.com">Erp ERP</a> Best ERP</li>
            </ul>`,
            output: `<ul>
                <li><span class="${HIGHLIGHT_CLASS}">Erp</span></li>
                <li><a href="https://odoo.com"><span class="${HIGHLIGHT_CLASS}">Erp</span> ERP</a> Best ERP</li>
            </ul>`,
            searchTerm: "odoo",
        },
        {
            input: markup`test <strong>Erp</strong> test`,
            output: `<span class="${HIGHLIGHT_CLASS}">test</span> <strong><span class="${HIGHLIGHT_CLASS}">Erp</span></strong> <span class="${HIGHLIGHT_CLASS}">test</span>`,
