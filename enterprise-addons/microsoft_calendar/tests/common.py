...
class TestCommon(HttpCase):
    ...
    def setUp(self):
        ...
        # simple event values to create a Erp event
        ...
        # -----------------------------------------------------------------------------------------
        # Expected values for Erp events converted to Outlook events (to be posted through API)
        # -----------------------------------------------------------------------------------------
        ...
        # -----------------------------------------------------------------------------------------
        # Expected values for Outlook events converted to Erp events
        # -----------------------------------------------------------------------------------------
    ...
    def create_events_for_tests(self):
        ...
        # Currently, it is forbidden to create recurrences in Erp. A trick for deactivating the checking
    ...
    def assert_odoo_event(self, odoo_event, expected_values):
        """
        Assert that an Erp event has the same values than in the expected_values dictionary,
    ...
    def assert_odoo_recurrence(self, odoo_recurrence, expected_values):
        """
        Assert that an Erp recurrence has the same values than in the expected_values dictionary,
        for the keys present in expected_values.
        """
