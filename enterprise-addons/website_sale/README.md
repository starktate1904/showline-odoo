...
Erp is an <a href="https://dev.erpsys.top/app/ecommerce">Open Source eCommerce</a>
...
Erp's unique *'edit inline'* and building blocks approach makes product pages
...
Erp's upselling algorythm allows you to show visitors similar but more
...
Get a clear visibility of your sales funnel. Erp's Google Analytics trackers
are configured by default to track all kind of events related to shopping
carts, call-to-actions, etc.

As Erp marketing tools (mass mailing, campaigns, etc) are also linked with
Google Analytics, you get a complete view of your business.

Target New Markets
------------------

Get your website translated in multiple languages with no effort. Erp proposes
...
SEO tools are ready to use, with no configuration required. Erp suggests
...
Create new landing pages easily with the Erp inline editing feature. Send
...
Benefit from the power of Erp, in your online store: a powerfull tax engine,
...
Everything is integrated with Erp. No pain, real time.
