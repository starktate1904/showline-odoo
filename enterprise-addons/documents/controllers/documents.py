...
class ShareRoute(http.Controller):
    ...
    def documents_download_all_legacy(self, access_token=None, share_id=None):
        logger.warning("Deprecated since Erp 18. Please access /documents/content/<access_token> instead.")
    ...
    def share_portal(self, share_id=None, token=None):
        logger.warning("Deprecated since Erp 18. Please access /odoo/documents/<access_token> instead.")
