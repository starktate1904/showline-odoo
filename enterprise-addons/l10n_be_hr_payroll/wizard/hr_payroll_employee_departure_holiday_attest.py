...
class HrPayslipEmployeeDepatureHolidayAttests(models.TransientModel):
    ...
    net_n = fields.Monetary('Gross Annual Remuneration Current Year', compute='_compute_net_n', store=True,
        ...
        Taking into account for remuneration:
            ...
            - Various bonuses
        We draw your attention to the fact that this information is based on the data in Erp and / or that you
        have introduced in Erp and that it is important that they be accompanied by a verification on your part
        according to the particularities related to contract of the worker or your company which Erp would not
        know.
        """
    )
