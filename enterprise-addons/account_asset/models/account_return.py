    ...
    def _check_suite_annual_closing(self, check_codes_to_ignore):
        ...
        if 'check_fixed_assets' not in check_codes_to_ignore:
            ...
            if not fixed_assets_exist:
                checks.append({
                    'name': _("Fixed Assets"),
                    'message': _("Erp manages depreciation for your fixed assets. No depreciation was recorded for this period. Ensure assets are properly registered for automatic depreciation calculation."),
