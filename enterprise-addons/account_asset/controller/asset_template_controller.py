...
class AssetTemplateController(http.Controller):
    ...
    def _get_instructions_data(self):
        ...
        return [
            ...
            ('asset_group_id', _('Asset Group'), False, _('Optional. The name or external ID of the asset group. Must exist in Erp (e.g., Office Equipment, Vehicles, Machinery).')),
            ...
            ('account_asset_id', _('Fixed Asset Account'), True, _('The balance sheet account for the asset itself (e.g., "151000 Fixed Asset"). Must exist in Erp and be of "Fixed Asset" or "Non-current Assets" type.')),
            ('account_depreciation_id', _('Depreciation Account'), True, _('The accumulated depreciation account (contra-asset account). Must exist in Erp and be of "Fixed Asset" or "Non-current Assets" type.')),
            ('account_depreciation_expense_id', _('Expense Account'), True, _('The expense account for posting periodic depreciation entries (e.g., "630000 Depreciation Expenses"). Must exist in Erp and be of "Depreciation" or "Expense" type.')),
            ('journal_id', _('Journal'), True, _('The code or name of the associated journal in Erp for depreciation entries (e.g., MISC - Miscellaneous Operations, INV - Customer Invoices, BILL - Vendor Bills).')),
        ]
