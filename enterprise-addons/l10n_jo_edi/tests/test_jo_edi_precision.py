...
class TestJoEdiPrecision(JoEdiCommon):
    ...
    def _validate_jo_edi_numbers(self, xml_string, invoice):
        ...
        Moreover, reported totals have to equal (or at least be as close as possible) to totals stored in Erp.
        And since the JOD has precision of 3 decimal places, everything is stored in Erp approximated to 3 decimal places.
        -------------------------------------------------------------------------------
