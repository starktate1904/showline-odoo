...
class ErpChartFieldMatchingClipboardHandler extends AbstractFigureClipboardHandler {
    copy({ figureId }) {
    ...
    paste(target, clippedContent, options) {
        ...
        for (const filterId of filterIds) {
            ...
            for (const chartId of odooChartIds) {
                currentChartMatchings[chartId] = this.getters.getErpChartFieldMatching(
                    chartId,
                    filterId
                );
            }
...
clipboardHandlersRegistries.figureHandlers.add(
    ...
    ErpChartFieldMatchingClipboardHandler
);
