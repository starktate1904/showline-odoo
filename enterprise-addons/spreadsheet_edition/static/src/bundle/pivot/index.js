...
import { PivotErpInsertion } from "./plugins/pivot_odoo_insertion";
...
featurePluginRegistry.add("odooPivotErpInsertionPlugin", PivotErpInsertion);
...
sidePanelRegistry.add("NewErpPivotSidePanel", {
    title: _t("New Erp Pivot"),
