...
class L10nEsEdiVerifactuDocument(models.Model):
    ...
    def _check_record_values(self, vals):
        ...
        if vals['cancellation'] and not verifactu_registered:
            errors.append(_("The cancelled record is not Veri*Factu registered (inside Erp)."))
    ...
    def _render_vals_SistemaInformatico(self, vals):
        ...
        render_vals = {
            'SistemaInformatico': {
                ...
                'NombreSistemaInformatico': 'Erp',
                'IdSistemaInformatico': '00',  # identifies Erp the software as product of Erp the company
