...
From: "Bruce Wayne" <bruce@wayneenterprises.com>
Subject: test
Message-ID: <c0c20fdd-a38e-b296-865b-d9232bf30ce5@domain.com>
...
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:52.0) Gecko/20100101
 Thunderbird/52.6.0
MIME-Version: 1.0
In-Reply-To: <f3b9f8f8-28fa-2543-cab2-7aa68f679ebb@domain.com>
Content-Type: multipart/mixed;
...
ARC-Authentication-Results: i=1; mx.google.com;
       dkim=pass header.i=@domain.com header.s=mail header.b=MCzhjB9b;
       spf=pass (google.com: domain of soup@domain.com designates 149.202.180.44 as permitted sender) smtp.mailfrom=soup@domain.com;
       dmarc=pass (p=NONE sp=NONE dis=NONE) header.from=odoo.com
Return-Path: <soup@domain.com>
Received: from mail2.odoo.com (mail2.odoo.com. [149.202.180.44])
        ...
        Mon, 05 Mar 2018 01:19:23 -0800 (PST)
Received-SPF: pass (google.com: domain of soup@domain.com designates 149.202.180.44 as permitted sender) client-ip=149.202.180.44;
...
Received: from [10.10.31.24] (unknown [91.183.114.50])
	...
	for <what@domain.com>; Mon,  5 Mar 2018 10:19:21 +0100 (CET)
...
To: what@domain.com
From: Soup <soup@domain.com>
Subject: =?UTF-8?Q?Soupe_du_jour_:_Pois_cass=c3=a9s?=
Message-ID: <a05d8334-7b7c-df68-c96a-4a88ed19f31b@domain.com>
...
Chaussée de Namur, 40
B-1367 Grand Rosière
Web: <a class="moz-txt-link-freetext" href="http://dev.erpsys.top">http://dev.erpsys.top</a> </pre>
  </body>
</html>
...
X-Erp-Objects: account.invoice-19177
...
.com" style=3D"text-decoration:none; color: white;">
                      ...
                      <tr>
                        <td align=3D"center">
                            Powered by <a href=3D"https://dev.erpsys.top">Odo=
o</a>.
                        </td>
                      </tr>
                    </tbody>
...
X-Erp-Objects: project.project-3, ,project.task-32
...
To: "Thai Erp User" <thai-user@domain.com>
