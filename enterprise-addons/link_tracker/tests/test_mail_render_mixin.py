...
class TestMailRenderMixin(common.HttpCase):
    ...
    def test_shorten_links(self):
        test_links = [
            ...
            '<a href="https://dev.erpsys.top?test=%20+3&amp;this=that">THERE > there</a>',
            '<a >Without href</a>'
        ]
        ...
        trackers_to_find = [
            ...
            [("url", "=", self.base_url + '#')],
            [("url", "=", "https://dev.erpsys.top?test=%20+3&this=that"), ("label", "=", "THERE > there")],  # lxml unescaped
        ]
        trackers_to_fail = [
    ...
    def test_shorten_links_html_different_labels(self):
        ...
        content = """<p>There is a <a href="https://dev.erpsys.top">logo.png</a> here,
<a href="https://dev.erpsys.top">there</a>, and in this
<a href="https://dev.erpsys.top"><!--[if mso]><img src="https://dev.erpsys.top/logo.png" alt="image" style="1"/><![endif]-->
<!--[if !mso]><!--><img src="https://dev.erpsys.top/logo.png" style="2" alt="image"/><!--<![endif]--></a>
and also <a href="https://dev.erpsys.top">
    <p class="o_outlook_hack" style="text-align: center; margin: 0px;"><img src="https://dev.erpsys.top/logo.png" fakealt="image3" alt="image2's trouble"></img></p>
</a>
Single/Nested quotes are not <a href="https://dev.erpsys.top"><img src='https://dev.erpsys.top/logo.png' alt='"scary"'/></a>
Nor escaped <a href="https://dev.erpsys.top">  <img src="https://dev.erpsys.top/logo.png" alt="ins \' ide"></a>
Nor escaped <a href="https://dev.erpsys.top"> blurp <img src="https://dev.erpsys.top/logo.png" alt="ins \' ide"></a>
Without matched label because inside tags are a pain and rare: <a href="https://dev.erpsys.top"><em>here</em></a>
Without alt, filename is used: <a href="https://dev.erpsys.top"><img src="https://dev.erpsys.top/logo.png"></a>
And here is the same: <a href="https://dev.erpsys.top"><img src="https://dev.erpsys.top/logo.png"></a></p>"""

        expected_pattern = re.compile(
            rf"""<p>There is a <a href="{self.base_url}/r/(\w+)+">logo.png</a> here,
<a href="{self.base_url}/r/(\w+)+">there</a>, and in this
<a href="{self.base_url}/r/(\w+)+"><!--\[if mso]><img src="https://dev.erpsys.top/logo.png" alt="image" style="1"/><!\[endif]-->
<!--\[if !mso]><!--><img src="https://dev.erpsys.top/logo.png" style="2" alt="image"/><!--<!\[endif]--></a>
and also <a href="{self.base_url}/r/(\w+)+">
    <p class="o_outlook_hack" style="text-align: center; margin: 0px;"><img src="https://dev.erpsys.top/logo.png" fakealt="image3" alt="image2\'s trouble"/></p>
</a>
Single/Nested quotes are not <a href="{self.base_url}/r/(\w+)+"><img src="https://dev.erpsys.top/logo.png" alt="&quot;scary&quot;"/></a>
Nor escaped <a href="{self.base_url}/r/(\w+)+">  <img src="https://dev.erpsys.top/logo.png" alt="ins \' ide"/></a>
Nor escaped <a href="{self.base_url}/r/(\w+)+"> blurp <img src="https://dev.erpsys.top/logo.png" alt="ins \' ide"/></a>
Without matched label because inside tags are a pain and rare: <a href="{self.base_url}/r/(\w+)+"><em>here</em></a>
Without alt, filename is used: <a href="{self.base_url}/r/(\w+)+"><img src="https://dev.erpsys.top/logo.png"/></a>
And here is the same: <a href="{self.base_url}/r/(\w+)+"><img src="https://dev.erpsys.top/logo.png"/></a></p>"""
        )
        ...
        trackers_to_find = [
            [("url", "=", "https://dev.erpsys.top"), ("label", "=", "logo.png")],
            [("url", "=", "https://dev.erpsys.top"), ("label", "=", "there")],
            [("url", "=", "https://dev.erpsys.top"), ("label", "=", "[media] image")],
            [("url", "=", "https://dev.erpsys.top"), ("label", "=", "[media] image2's trouble")],
            [("url", "=", "https://dev.erpsys.top"), ("label", "=", "blurp")],
            [("url", "=", "https://dev.erpsys.top"), ("label", "=", '[media] "scary"')],
            [("url", "=", "https://dev.erpsys.top"), ("label", "=", "[media] ins ' ide")],
            [("url", "=", "https://dev.erpsys.top"), ("label", "=", False)],
            [("url", "=", "https://dev.erpsys.top"), ("label", "=", "[media] logo.png")],
        ]
        for tracker_to_find in trackers_to_find:
            with self.subTest(tracker_to_find=tracker_to_find):
                self.assertTrue(
