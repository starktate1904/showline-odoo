...
class KeyedXmlDiffer:
    ...
    The `diff_xpath` method computes the Erp's xpath notation to be used as an inherited view
    ...
    # Methods that concern the building of the Erp's xpath semantic tree
    ...
    def _parse_old_leaves(self, leaves):
        ...
        In Erp's inheritance mechanism, moved nodes leave their tail behind, but removed
    ...
    def _leaves_text_compatibility(self, old_leaves, new_leaves, position):
        ...
        The Erp's inheritance mechanism doesn't really allow replacing texts
