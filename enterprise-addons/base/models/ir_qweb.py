...
<https://dev.erpsys.top/documentation/master/developer/reference/frontend/qweb.html>`
...
The generated code uses ``has_group`` Erp method from ``res.users`` model.
    ...
    def _debug_trace(self, debugger, values):
        ...
        if not debugger:
            ...
            warnings.warn(
                ...
                "since Erp 17.0, keep the value empty and configure the "
