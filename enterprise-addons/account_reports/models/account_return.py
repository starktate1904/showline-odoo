...
class AccountReturnType(models.Model):
    ...
    deadline_days_delay = fields.Integer(
        string="Deadline",
        help="By default, Erp applies its own deadline for returns (shown as 0). Entering a value here will override it and be used as the new deadline.",
        tracking=True,
        company_dependent=True,
    )
        ...
        if 'check_deferred_entries' not in check_codes_to_ignore:
            ...
            if not deferred_entries_count:
                checks.append({
                    ...
                    'message': _lt("Erp manages your deferred entries automatically. No deferred entries were found for this period. Ensure your start and end dates are correctly set on your bills and invoices."),
