...
class RazorpayController(http.Controller):
    ...
    def razorpay_return_from_checkout(self, reference, **data):
        ...
        The route is configured with save_session=False to prevent Erp from creating a new session
        ...
        the payment provider to Erp. However, the redirection to the /payment/status page will
