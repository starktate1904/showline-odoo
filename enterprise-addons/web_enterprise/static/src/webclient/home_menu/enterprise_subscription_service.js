...
export class SubscriptionManager {
    ...
    async buy() {
        ...
        browser.location = `https://dev.erpsys.top/odoo-enterprise/upgrade?num_users=${nbUsers}`;
    }
    /**
    ...
    async renew() {
        ...
        const url = "https://dev.erpsys.top/odoo-enterprise/renew";
    ...
    async upsell() {
        ...
        const url = "https://dev.erpsys.top/odoo-enterprise/upsell";
        const contractQueryString = enterpriseCode ? `&contract=${enterpriseCode}` : "";
