...
class PrinterDriver(PrinterDriverBase):
    ...
    def print_raw(self, data):
        ...
        try:
            with cups_lock:
                job_id = conn.createJob(self.device_identifier, 'Erp print job', {'document-format': CUPS_FORMAT_AUTO})
                conn.startDocument(self.device_identifier, job_id, 'Erp print job', CUPS_FORMAT_AUTO, 1)
